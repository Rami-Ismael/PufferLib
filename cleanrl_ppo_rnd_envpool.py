...
#from pufferlib.pufferlib import vectorization
...
if __name__ == "__main__":
    ...
    print(
        f"Show the keys for hte flat observation space: {envs.flat_observation_space.keys()}\n"
    )
    pixel_screen_flat_shape = np.sum(envs.flat_observation_space["Dscreen.V"].shape)
